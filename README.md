...
Note that this will only modify comp duration, keyframe position and layer timing. It will not modify any stagger, oscillator or similar procedural elements.
...
If you're looking for a more polished value graph editor that supports Magic Easing, check out Curves at Scenery.io. Make sure to download "easey_assets" as well.
